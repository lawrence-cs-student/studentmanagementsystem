...
--
-- Table structure for table `avaiable schedule`
--

CREATE TABLE `avaiable schedule` (
...
(8, 'mark@mail.com', 'mark@mail.com', 'YWRtaW4xMjM=', 'Zeno', 'Mark', 'A', 'september 5, 2002', 'tanauan', '09154312345', 0, 1728264214);
...
--
-- Indexes for table `avaiable schedule`
--
ALTER TABLE `avaiable schedule`
...
('root', '[{\"db\":\"managementsystem\",\"table\":\"users\"}]');
...
('root', '2024-10-07 00:37:33', '{\"Console\\/Mode\":\"collapse\"}');
